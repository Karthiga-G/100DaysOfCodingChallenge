//Challenge - Integers and Positions (Odd/Even)

/*
The program must accept N integers as the input. The program must print the odd integers which are
present in the even positions and print the even integers which are present in the odd positions
among the N integers. If there is no such integer, the program must print -1 as the output.
