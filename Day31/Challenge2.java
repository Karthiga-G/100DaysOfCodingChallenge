//Challenge - Binary Sequence(1 to N)

/*
The program must accept an integer N as the input. The program must print the binary representation
of the integers from 1 to N as the output.
